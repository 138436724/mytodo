    ...
    this.draw = function () {
        ...
        this.sn.forEach((t, e, i) => {
            if (0 == e || i.length - 1 == e) {
                ...
                i.length - 1 == e ? (n.addColorStop(0, "black"),
                    n.addColorStop(1, "#8BC34A")) : (n.addColorStop(0, "#8BC34A"),
...
key = {},
    key.keydown = function (t) {
        ...
        Object.defineProperty(e, "keyCode", {
            ...
            e.initKeyboardEvent ? e.initKeyboardEvent("keydown", !0, !0, document.defaultView, !1, !1, !1, !1, t, t) : e.initKeyEvent("keydown", !0, !0, document.defaultView, !1, !1, !1, !1, t, 0),
            e.keyCodeVal = t,
...
window.onkeydown = function (t) {
    ...
    (e.search("Arrow") > -1 || "1" == e) && (d = t.key),
        "i" != e && "I" != e || (console.log("inc"),
            fw -= 10),
        "d" != e && "D" != e || (console.log("dec"),
            fw += 10)
}
    ,
    init();
